...
pygame.mixer.init()
try:
    comet_pass_sound = pygame.mixer.Sound("c:\\2025_AI\\project\\spaceship_sounds\\sounds_comet_hit.wav")  # 혜성 스칠 때 사운드
    comet_hit_sound = pygame.mixer.Sound("c:\\2025_AI\\project\\spaceship_sounds\\sounds_comet_pass.wav")  # 혜성 맞을 때 사운드 추가
...
# 이미지 로드
spaceship_image = pygame.image.load("c:\\2025_AI\\project\\spaceship_images\\ship.png")  # 우주선 이미지
comet_images = [
    pygame.image.load(f"c:\\2025_AI\\project\\spaceship_images\\comet{i}.png") for i in range(1, 13)
]  # 혜성 이미지 1~12
